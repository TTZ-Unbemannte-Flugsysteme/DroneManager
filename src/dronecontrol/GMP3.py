...
class GMP3:
    ...
    def calculate(self, startposition, finalposition):
        ...
        self.tf     = (self.x_f2 - self.x_in+3) if (self.x_f2 - self.x_in+3) > (self.y_f2 - self.y_in+3) else (self.y_f2 - self.y_in+3)
        ...
        tolerance = 0.08  # Define a small tolerance value for the stopping criterion
        ...
        gradient_tolerance = 1e-12  # Tolerance for gradient norm
        ...
        t, x, y, xdot, ydot, ux, uy = self.results(self.x_in, self.y_in, self.x_f1, self.x_f2, self.y_f1, self.y_f2,  theta[:, i])
